...
public class AppointmentListView extends JFrame {
    ...
    public AppointmentListView(List<Appointment> appointments) {
        ...
        String[] columnNames = { "Animal Name", "Owner Name", "Vet Name", "Date & Time", "Report",
                "Status" };
        ...
        for (Appointment appointment : appointments) {
            ...
            Object[] rowData = {
                    ...
                    appointment.getReport() != null ? new String(appointment.getReport()) : "No Report",
                    statusName
            };
    ...
    public static void main(String[] args) {
        ...
        User owner2 = new User("CF002", "password456", "Jane", "Smith", "987654321");
        ...
        Animal animal2 = new Animal(2, "Whiskers", LocalDate.of(2018, 3, 15), owner2,
                breed2);

        // Creazione di alcuni veterinari
        Vet vet1 = new Vet("CFV001", "vetpassword1", "Dr.", "Jones", "111222333");
        Vet vet2 = new Vet("CFV002", "vetpassword2", "Dr.", "Smith", "444555666");
        ...
        appointments.add(
                new Appointment(
                        ...
                        animal2,
                        vet2,
                        LocalDateTime.of(2024, 8, 20, 15, 00),
                        "Report 2".getBytes(),
                        state2));

        // Visualizzazione della finestra con gli appuntamenti
        new AppointmentListView(appointments);
